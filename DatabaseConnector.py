...
class DatabaseConnector():
    ...
    def fill_respawn_list(self):
        ...
        self.sql_edit('''INSERT INTO spawns(city, code, name) values('Kazordoon', 'K1', 'Warzone 4')''')
        self.sql_edit('''INSERT INTO spawns(city, code, name) values('Kazordoon', 'K2', 'Warzone 5')''')
        self.sql_edit('''INSERT INTO spawns(city, code, name) values('Kazordoon', 'K3', 'Warzone 6')''')
        self.sql_edit('''INSERT INTO spawns(city, code, name) values('Kazordoon', 'K4', 'Warzone 6 after TP')''')
